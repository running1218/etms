<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="TraningPlanView.aspx.cs" Inherits="TraningPlan_TraningPlan_TraningPlanView" %>

<%@ Register Src="Controls/PlanInfoView.ascx" TagName="PlanInfoView" TagPrefix="uc3" %>
<%@ Register Src="Controls/CourseListView.ascx" TagName="CourseListView" TagPrefix="uc4" %>
