...
s.a("<div style='float:left;margin:2px 0;'><div style='margin-left:0px' class='ymsel'></div><input class='yminput' style='margin-top:-1px;width:40px;' maxlength=4></div>");
s.a("<div style='float:right;margin:2px 0;width:45px;text-align:right;'><img style='cursor:pointer;' src='skin/" + this.skin + "/right.gif' width=14 height=16 /><img style='cursor:pointer;' src='skin/" + this.skin + "/navRight.gif' width=14 height=16 /></div></div>");
s.a("<div></div>");
s.a("<div>");
