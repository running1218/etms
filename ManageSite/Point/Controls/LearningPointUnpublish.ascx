<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LearningPointUnpublish.ascx.cs" Inherits="Point_Controls_LearningPointUnpublish" %>
        ...
        <cc1:CustomGridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="积分原因" ItemStyle-CssClass="alignleft" HeaderStyle-CssClass="alignleft">
                    <ItemTemplate>
                        <cc1:ShortTextLabel ID="lblPointReason" runat="server" ShowTextNum="10" Text='<%#Eval("PointReason")+string.Format("【项目名称：{0}】 ",Eval("ItemName")) %>' />
                    </ItemTemplate>
                </asp:TemplateField>
               ...
               <asp:TemplateField HeaderText="创建日期" ItemStyle-CssClass="alignleft" HeaderStyle-CssClass="alignleft"  HeaderStyle-Width="80">
                    <ItemTemplate>
