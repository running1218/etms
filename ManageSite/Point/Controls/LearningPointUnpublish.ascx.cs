...
public partial class Point_Controls_LearningPointUnpublish : System.Web.UI.UserControl
{
    ...
    private System.Collections.IList PageDataSource(int pageIndex, int pageSize, out int totalRecordCount)
    {
        ...
        DataTable dt = pointReasonDetailLogic.GetStudentInputPointAllInfoList( pageIndex, pageSize, " u.OrganizationID,u.RealName,u.DepartmentID", crieria, out totalRecordCount);
