<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="ManualSetupPoint.aspx.cs" Inherits="Point_CoursePointManager_ManualSetupPoint" %>
        ...
        <div class="dv_Tabmenus">
            <ul>
                <li id="Tab_0" onclick="showTab('Tab_0', 'Div_Select_0','selected')"><a onfocus="blur()"
                    href="javascript:void(0);"><span class="bj">未设置</span></a></li>
                <li id="Tab_1" onclick="showTab('Tab_1', 'Div_Select_1','selected')"><a onfocus="blur()"
                    href="javascript:void(0);"><span class="bj">已设置</span></a></li>
            </ul>
        </div>
    </div>
    <div class="info">
        <div id="Div_Select_0" style="display: none">
            ...
            <div class="dv_GradeviewList">
                <table class="" runat="server">
                    <tr id="NotSettrOrg" runat="server">
                        <th>
                            组织机构：
                        </th>
                        <td colspan="3">
                            <cc1:DictionaryDropDownList ID="ddl_NotSet_OrganizationID" runat="server" DictionaryType="Dic_CurrentAndSubOrganization"
                                IsShowAll="true" AutoPostBack="true" OnSelectedIndexChanged="ddl_NotSet_Organization_SelectedIndexChanged"
                                CssClass="select_210" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddl_NotSet_DepartmentID" runat="server" CssClass="select_190" />
                        </td>
                        <th width="120">
                            学员姓名：
                        </th>
                        <td>
                            <asp:TextBox ID="txt_NotSet_StudentName" runat="server"></asp:TextBox>
                            <asp:Button ID="btnNotSetSeach" runat="server" Text="查询" CssClass="btn_Search" OnClick="btnNotSetSeach_Click" />
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <div class="dv_pagePanel" id="div2">
                    <div class="dv_selectAll">
                        ...
                        <cc1:CustomButton runat="server" ID="btnPoint" Visible="true" CssClass="btn_integral"
                            Text="设置积分" OnClick="btnPoint_Click" EnableConfirm="true" ConfirmTitle="提示" ConfirmMessage="您确认进行设置积分操作吗？" />
                        <cc1:CustomButton runat="server" ID="btnAllPoint" Visible="true" CssClass="btn_integral"
                            Text="全部设置" OnClick="btnAllPoint_Click" EnableConfirm="true" ConfirmTitle="提示"
                            ConfirmMessage="您确认进行全部设置积分操作吗？" />
                    </div>
