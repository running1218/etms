<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPages/MPagePop.Master" CodeFile="SetRecommendCourseSort.aspx.cs" Inherits="SiteManage_RecommendCourse_SetRecommendCourseSort" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#inpSave").click(function () {
                ...
                if (ItemCourseIDs == "") {
                    popAlertMsg('没有可排序的推荐课程。', '提示');
                    return;
                }

                $.post("../Controls/ItemCourseRecommendSort.ashx", {
                    ItemCourseIDs: ItemCourseIDs
                }, function (data) {
                    if (data == "success") {
                        popSuccessMsg('推荐课程排序成功。', '提示',
                            function () { window.parent.location = window.parent.location });
                    } else {
                        popFailedMsg('推荐课程排序失败。原因如下：' + data, '提示');
                    }
                });
            });
