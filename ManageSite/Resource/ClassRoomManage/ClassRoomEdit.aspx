<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPagePop.Master" AutoEventWireup="true"
    CodeFile="ClassRoomEdit.aspx.cs" Inherits="ETMS.WebApp.Manage.Resource.ClassRoomManage.ClassRoomEdit" %>
    ...
    <div class="dv_information">
        <table class="GridviewGray fixedTable">
            <tr>
                ...
                <td >
                    <asp:TextBox ID="txtClassRoomCode" runat="server" CssClass="inputbox_210" MaxLength="50"></asp:TextBox>
            ...
            <tr>
                ...
                <td >
                    <asp:TextBox ID="txtClassRoomName" runat="server" CssClass="inputbox_300" MaxLength="100"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span style="color: Red;">*</span><asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                        runat="server" ErrorMessage="请填写教室名称！" ControlToValidate="txtClassRoomPurpose"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDutyUser" runat="server" CssClass="inputbox_120" MaxLength="60"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="validator" ValidationExpression="^[\+\-]?\d*?\.?\d*?$"
                        ControlToValidate="txtPrice" ErrorMessage="价格格式错误！" ValidationGroup="Edit" runat="server"
                        Display="None" />
                </td>
            </tr>
            <tr>
