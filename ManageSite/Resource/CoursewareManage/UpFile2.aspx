<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="UpFile2.aspx.cs" Inherits="Resource_CoursewareManage_UpFile2" %>
...
<form runat="server">
    ...
    <script type="text/javascript">
        ...
        function UpFileSuccess(fileName) {
            ...
            $(window.parent.document).find(".lblState").html("<span class='colorGreen'>上传成功。</span>");
