<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="TeacherCourseList.aspx.cs" Inherits="ETMS.WebApp.Manage.TeacherCourseList" %>
                    ...
                    <cc1:CustomGridView ID="gvList" runat="server" CssClass="GridviewGray" EmptyDataSourceTip="没有任何记录！"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作" HeaderStyle-Width="200px">
                                ...
                                <ItemTemplate>
                                    <a href='<%# this.ActionHref(string.Format("CourseDesign.aspx?CourseID={0}&From=T",Eval("CourseID").ToString())) %>'>课程设计</a>
