<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MPageAdmin.master"
    CodeFile="StatDefault.aspx.cs" Inherits="QS_StatDefault" %>
        ...
        <cc1:CustomGridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="调查时间" HeaderStyle-Width="140">
                    ...
                    <ItemTemplate>
                        <cc1:DateTimeLabel ID="DateTimeLabel1" runat="server" DateTimeValue=' <%#Eval("BeginTime")%>'></cc1:DateTimeLabel>~
                        <cc1:DateTimeLabel ID="DateTimeLabel2" runat="server" DateTimeValue=' <%#Eval("EndTime")%>'></cc1:DateTimeLabel>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="调查总人数" HeaderStyle-CssClass="alignleft" HeaderStyle-Width="100">
                    <ItemStyle HorizontalAlign="Center" />
                    <ItemTemplate>
                        <%--<asp:Label runat="server" ID="lblTotalCount" Text='<%#Eval("InvestNumber") %>'></asp:Label>--%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField ShowHeader="False" HeaderText="操作" HeaderStyle-Width="250">
                    <ItemTemplate>
                        <a href='javascript:showWindow("查看调查问卷","<%# this.ActionHref(String.Format("View.aspx?op=view&id={0}", new Object[]{Eval("QueryID")})) %>")'>
                            查看</a> <a href='<%# this.ActionHref(String.Format("../QueryStatResult.aspx?QueryID={0}&={1}", new Object[]{Eval("QueryID"),this.PollType})) %>'
                                target="QueryPreView">调查结果</a>
                        <asp:HyperLink runat="server" ID="hlUpload">上传分析报告</asp:HyperLink>
                        <asp:HyperLink runat="server" ID="hlSetScore">设置综合分数</asp:HyperLink>
