<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResourceQueryStudentAdd.aspx.cs"
    MasterPageFile="~/MasterPages/MPageAdmin.Master" Inherits="QS_ResourceQueryStudentAdd" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="rblAreaType" EventName="SelectedIndexChanged" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                    <%} %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger EventName="SelectedIndexChanged" ControlID="ddlOrg" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                    <th style="width: 120">
