...
public partial class QS_DownLoadFailed : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        System.Data.DataTable dt = logic.GetPagedList(1, int.MaxValue - 1, "", " and Taskid=" + taskid + " and Status=0", out record);
        //导出的excel文件名
        ...
        //复制excel
        System.IO.File.Copy(Server.MapPath("../QS/Template/PollStudentImportError.xls"), fullXlsFilePath, true);
        //按照excelsheet结构构造数据表
