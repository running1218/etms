<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ExerciseInfo.ascx.cs"
    Inherits="QuestionDB_ExOnlineHomework_Controls_ExerciseInfo" %>
...
<div class="dv_information">
    <table class="GridviewGray">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtOnlineJobName" runat="server" CssClass="inputbox_210" MaxLength="50"></asp:TextBox>
<asp:RequiredFieldValidator ID="RequiredFieldValidatorName" runat="server" ControlToValidate="txtOnlineJobName" Display="None" ErrorMessage="请填写作业名称！" ValidationGroup="Error"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td>
                <cc1:DictionaryRadioButtonList runat="server" ID="rbtnOnLineJobStatus" DictionaryType='Dic_Status' />
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtOnLineJobDesc" runat="server" CssClass="inputbox_area300" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
    </table>
</div>
