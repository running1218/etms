...
public partial class ResourceExerciseList : System.Web.UI.UserControl
{
    #region 页面参数
    /// <summary>
    /// 查询条件 
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        btnAdd.Attributes.Add("onclick", string.Format("javascript:showWindow('新增在线作业','{0}');javascript:return false;", this.ActionHref(string.Format("~/QuestionDB/ExOnlineHomework/ExerciseAdd.aspx?CourseID={0}", CourseID))));
    }
