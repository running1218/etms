<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPagePop.Master" AutoEventWireup="true"
    CodeFile="QuestionView.aspx.cs" Inherits="QuestionDB_QuMultipleChoice_QuestionView" %>
    ...
    <div class="dv_information">
        ...
        <table class="GridviewGray fixedTable">
            ...
            <tr>
                ...
                <p>
                   <input type="checkbox" id="rbtnOption_<%=i %>" name="myradio" <%= GetQuestionChecked(i) %>  /><%= GetQuestionOptionContent(i) %>
                   </p>
                   <% }%>
                </td>
            </tr>
