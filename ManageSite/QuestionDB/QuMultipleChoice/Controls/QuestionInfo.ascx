<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QuestionInfo.ascx.cs"
    Inherits="QuestionDB_QuMultipleChoice_Controls_QuestionInfo" %>
...
<script type="text/javascript">
    function checkTitle() {
        ...
        if (p.length == 0) {
            ...
            var q = saveFunoption('multi', "<%=hfldOptionList.ClientID %>");
            return q;
        }
    }
...
<div class="dv_information">
    ...
    <table class="GridviewGray GridviewGrayboder">
        ...
        <tr id="tr_<%=i %>">
            <td class="center">
                <input type="checkbox" id="checkOption_<%=i %>" name="myradio" <%= GetQuestionChecked(i) %> />
            ...
            <td class="center">
                <textarea type="text" id="txtOptionContent_<%=i%>" class="inputbox_area360 inputbox_area360_hight"
    ...
    <div style="padding-left: 10px!important; *padding-left: 6px;">
        <input type="button" id="addansweroption" onclick="addoption('multi')" class="btn_AddNew"
            value="增加答案选项" />
    </div>
