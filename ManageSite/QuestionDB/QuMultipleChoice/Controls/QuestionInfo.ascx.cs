...
public partial class QuestionDB_QuMultipleChoice_Controls_QuestionInfo : System.Web.UI.UserControl
{
    #region 页面条件参数存放
    ...
    public MultipleChoiceQuestion eQuestion
    {
        //get
        //{
        //    return (MultipleChoiceQuestion)ViewState["eQuestion"];
        //}
        //set
        //{
    ...
    {
        //lbtnSave.Attributes.Add("onclick", "javascript:return saveFunoption('multi','" + hfldOptionList.ClientID + "')");
        if (!IsPostBack)
        {
            //获取题库实体
    ...
    private bool InitialEntity()
    {
        if (Action == OperationAction.Add)
        {
            eQuestion = new MultipleChoiceQuestion();
        ...
        //test
        //hfldOptionList.Value = "trueΩ2b9caa3a-0566-4afb-862e-effa1b1a08daΩ北京ΦtrueΩ2b9caa3a-0566-4afb-863e-effa1b1a08daΩ广州ΦfalseΩ2b9caa4a-0566-4afb-862e-effa1b1a08daΩ长沙ΦfalseΩ2b9caa4a-0566-4afb-852e-effa1b1a08daΩ上海"; 
        ...
        if (eQuestion.Answer.AnswerOptions.Count < 1)
        {
            ETMS.Utility.JsUtility.AlertMessageBox("请至少选择一个正确答案！");
            return false;
        }
    ...
    protected void lbtnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ETMS.Utility.JsUtility.SuccessMessageBoxAndCloseWindowAndTriggerRefreshEvent("多选题保存成功，点击“确定”后，重新刷新当前页数据！");
        }
