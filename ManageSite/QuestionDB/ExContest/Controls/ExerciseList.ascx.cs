...
public partial class QuestionDB_ExContest_Controls_ExerciseList : System.Web.UI.UserControl
{
    #region 页面参数
    /// <summary>
    /// 查询条件 
    ...
    private System.Collections.IList PageDataSource(int pageIndex, int pageSize, out int totalRecordCount)
    {
        ...
        Ex_ContestLogic contesetLogic = new Ex_ContestLogic();

        DataTable dt = contesetLogic.GetPagedList(pageIndex, pageSize, SortExpression, Crieria, out totalRecordCount);
    ...
    protected void CustomGridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Del")
        {
            ...
            {
                Ex_ContestLogic contesetLogic = new Ex_ContestLogic();
                contesetLogic.Remove(new Guid(e.CommandArgument.ToString()));
                //this.PageSet1.QueryChange();
    ...
    protected int getExerciseType()
    {
        ...
        return (int)ETMS.Components.Basic.Implement.BLL.BizExerciseType.ExContest;
    }
