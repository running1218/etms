...
using ETMS.WebApp;
using System.Data;
public partial class Mentor_MentorManage_SetsMentorList : System.Web.UI.Page
{
    ...
    protected void CustomGridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow) {
            e.Row.Cells[6].Text = "<a href=\"javascript:showWindow('查看导师','SetsMentorView.aspx')\">" + e.Row.Cells[6].Text + "</a>";
        }
    }
}