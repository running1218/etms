<%@ Page Title="设置导师" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master" AutoEventWireup="true" CodeFile="SetsMentorList.aspx.cs" Inherits="Mentor_MentorManage_SetsMentorList" %>
            ...
            <cc1:CustomGridView ID="CustomGridView1" runat="server" AutoGenerateColumns="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        ...
                        <ItemTemplate>
                            <a href="javascript:showWindow('指定导师','SetsMentor.aspx')">指定导师</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </cc1:CustomGridView>
