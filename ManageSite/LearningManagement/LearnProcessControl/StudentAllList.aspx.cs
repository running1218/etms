...
public partial class LearningManagement_LearnProcessControl_StudentAllList : System.Web.UI.Page
{
    #region 页面参数
    /// <summary>
    /// 项目ID
    ...
    private System.Collections.IList PageDataSource(int pageIndex, int pageSize, out int totalRecordCount)
    {
        ...
        DataTable dt = StudentCourseLogic.GetStudentForSelectedCourse(TrainingItemCourseID);
