...
public partial class IDP_ManageIDP_Contorls_IDPInfo : System.Web.UI.UserControl
{
    #region 页面参数
    ...
    private void InitData()
    {
        try
        {
            ...
            lblCloseTime.Text = plan.CloseTime.ToDate();
            lblCompletionRate.Text = plan.CompletionRate.ToString() + "%";
            lblEvaluation.Text = plan.Evaluation;
        }
