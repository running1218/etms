<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnInvestDetail.aspx.cs" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    Inherits="Poll_ResourceQuery_UnInvestDetail" %>
        ...
        <div class="dv_searchlist">
            ...
            <div class="dv_pagePanel">
                <div class="dv_selectAll">
                    ...
                    <cc1:CustomButton CssClass="btn_SaveFour" Text="发送邮件" runat="server" ID="btnSendEmail"
                        EnableConfirm="true" ConfirmMessage="确定要给未提交的人员发送邮件吗?" OnClick="btnSendEmail_Click" />
                </div>
            ...
            <cc1:CustomGridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="提交状态" HeaderStyle-CssClass="alignleft">
                        <ItemStyle CssClass="alignleft" />
                        <ItemTemplate>
                            <cc1:ShortTextLabel ID="ShortTextLabel1" runat="server" Text='未提交'></cc1:ShortTextLabel>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="学员状态" HeaderStyle-CssClass="alignleft">
                        <ItemStyle CssClass="alignleft" />
                        <ItemTemplate>
                            <cc1:ShortTextLabel ID="ShortTextLabel1" runat="server" Text='<%# ((int)Eval("UserStatus")==0) ? "停用" : "启用" %>'></cc1:ShortTextLabel>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </cc1:CustomGridView>
            ...
            <cc1:CustomGridView ID="CustomGridView1" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="提交状态">
                        ...
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='未提交'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="学员状态" HeaderStyle-CssClass="alignleft">
                        <ItemStyle CssClass="alignleft" />
