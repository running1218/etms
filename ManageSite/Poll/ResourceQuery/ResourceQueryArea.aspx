<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    CodeFile="ResourceQueryArea.aspx.cs" Inherits="Poll_ResourceQuery_ResourceQueryArea" %>
                ...
                <div class="dv_searchlist">
                    ...
                    <div class="dv_pagePanel">
                        <div class="dv_selectAll">
                            ...
                            <input type="button" value="新增" class="btn_Add" onclick="window.location.href='<%=this.ActionHref(string.Format("ResourceQueryAreaAdd.aspx?QueryID={0}&PublishObjectID={1}",this.QueryID,this.CurrentQueryArea.QueryPublishID))%>'" />
                    ...
                    <ContentTemplate>
                        <div class="dv_pagePanel">
                            <div class="dv_selectAll">
                                ...
                                <input type="button" value="新增" class="btn_Add" onclick="window.location.href='<%=this.ActionHref(string.Format("ResourceQueryStudentAdd.aspx?QueryAreaID={0}&queryid={1}",this.CurrentQueryArea.QueryAreaID,QueryID))%>'" />
