<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MPagePop.Master"
    CodeFile="QuestionSort.aspx.cs" Inherits="Poll_QuestionManage_QuestionSort" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <table class="GridviewGray GridviewGrayboder">
            ...
            <tr>
                <td style="text-align: center;">
                    <select id="lbCourseSort" runat="server" class="list-box" size="25" style="width: 500px;">
                    </select>
    ...
    <div class="dv_submit">
        ...
        <span style="display: none">
            <asp:Button ID="btn_Save" runat="server" Text="保存" CssClass="btnsave1" /></span>
