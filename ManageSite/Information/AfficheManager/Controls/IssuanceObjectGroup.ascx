<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IssuanceObjectGroup.ascx.cs"
    Inherits="Information_AfficheManager_Controls_IssuanceObjectGroup" %>
...
<div class="dv_searchlist">
    ...
    <div class="dv_pagePanel" id="divPage1">
        <div class="dv_selectAll">
            ...
            <input id="btn_Add" type="button" class="btn_Add" value="新增" runat="server" onclick="javascript:showWindow('新增群组','IssuanceObjectGroupAdd.aspx',760,620)" />
            <input id="btn_Save" type="button" class="btn_Add" value="保存" runat="server" />
            <input id="btn_Del" type="button" class="btn_Del" value="删除" runat="server" />
        </div>
