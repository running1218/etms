<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NotifyConfig.aspx.cs" Inherits="Admin_Site_SysConfig_NotifyConfig"
    ValidateRequest="false" MasterPageFile="~/MasterPages/MPageAdmin.master" %>
...
<asp:Content runat="server" ID="PageContent" ContentPlaceHolderID="ContentPlaceHolder1">
   <div class="dv_pageInformation" style="margin-bottom:10px;">
    <a href="javascript:showWindow('消息提醒类别管理','<%=this.ActionHref("NotifyClassList.aspx")%>')" class="link_colorRed">
        消息提醒类别管理</a></div>
                ...
                <div id='<%#string.Format("Div_Select_{0}",Container.ItemIndex) %>' class="dv_pageInformation"
                    ...
                    <table class="GridviewGray">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtTemplateVariableDefine" TextMode="MultiLine" CssClass="inputbox_area440"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <th rowspan="2">
