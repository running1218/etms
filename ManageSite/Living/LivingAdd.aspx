<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LivingAdd.aspx.cs" Inherits="Living_LivingAdd" %>
        ...
        <div class="dv_information">
            <table class="GridviewGray fixedTable">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtStartTime" AutoCompleteType="Disabled" runat="server" CssClass="inputbox_190 datetimepicker-icon"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>                    
                        <asp:TextBox ID="txtEndTime" AutoCompleteType="Disabled" runat="server" CssClass="inputbox_190 datetimepicker-icon"></asp:TextBox>
