<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="CourseList.aspx.cs" Inherits="ETMS.WebApp.Manage.Living_CourseList" %>
        ...
        <div class="dv_searchbox">
            <table class="GridviewGray" border="0" cellpadding="0" cellspacing="0" runat="server"
                ...
                <tr>
                    ...
                    <td>
                        <cc1:DictionaryDropDownList runat="server" ID="ddl_LivingType" TabIndex="3" DictionaryType="Dic_Sys_LivingType"
                            CssText="select_120" IsShowAll="true" />
                    </td>
                </tr>
            </table>
        ...
        <div class="dv_searchlist">
            ...
            <div class="dv_pagePanel">
                <div class="dv_selectAll">
                    ...
                    <input id="btnSort" type="button" class="btn_Sort"  value="排序" title="精品课程排序" onclick="javascript:showWindow('精品课程排序','<%= SortUrl %>',500,420)" />
                </div>
            ...
            <cc1:CustomGridView ID="gvList" runat="server" CssClass="GridviewGray" EmptyDataSourceTip="没有任何记录！"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="直播类型" HeaderStyle-Width="60">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="是否收费" HeaderStyle-Width="60">
                        <ItemTemplate>
                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("IsPay").ToString()=="True"?"是":"否" %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="课程状态" HeaderStyle-Width="60">
                        <ItemTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("CourseStatus").ToString()=="1"?"启用":"停用" %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-Width="200px">
                        ...
                        <ItemTemplate>
                            <a href='<%# this.ActionHref(string.Format("LivingList.aspx?CourseID={0}",Eval("CourseID").ToString())) %>'>直播安排</a>
