<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MPagePop.Master" CodeFile="SetCourseSort.aspx.cs" Inherits="Living_CourseManage_SetCourseSort" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#inpSave").click(function () {
                ...
                $.post("Controls/LivingCourseSort.ashx", {
