...
public partial class Valuation_ItemCourseEvaluationApprove : System.Web.UI.Page
{
    #region 页面参数
    /// <summary>
    /// 项目ID
    ...
    protected void CustomGridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            LinkButton lbtn_ApproveList = (LinkButton)e.Row.FindControl("lbtn_ApproveList");
            if (lbtn_ApproveList != null)
            {
                lbtn_ApproveList.PostBackUrl = this.ActionHref(string.Format("~/Valuation/EvaluationApproveList.aspx?TrainingItemCourseID={0}&TrainingItemID={1}", TrainingItemCourseID, TrainingItemID));
            }
        }
    }
