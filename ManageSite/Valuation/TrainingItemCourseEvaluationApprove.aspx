<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master" AutoEventWireup="true" CodeFile="TrainingItemCourseEvaluationApprove.aspx.cs" Inherits="Valuation_TrainingItemCourseEvaluationApprove" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBack" runat="Server">
    <a href="ValuationCourseApprove.aspx" class="btn_Return">返回</a>
</asp:Content>
