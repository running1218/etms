<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master" AutoEventWireup="true" CodeFile="ItemCourseEvaluationApprove.aspx.cs" Inherits="Valuation_ItemCourseEvaluationApprove" %>
                ...
                <ContentTemplate>
                    ...
                    <cc1:CustomGridView ID="CustomGridView1" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="好评度" HeaderStyle-Width="60" HeaderStyle-CssClass="alignright" ItemStyle-CssClass="alignright" Visible="false">
                                <ItemTemplate>
                                    <%# initEvaluation(Eval("TrainingItemCourseID").ToString())%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="评价人次" HeaderStyle-Width="60">
                                <ItemTemplate>
                                    <%# UserCount%>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="操作" HeaderStyle-Width="60">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtn_ApproveList" runat="server" CommandName="ApproveList">点评审批</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </cc1:CustomGridView>
