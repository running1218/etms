...
public partial class Valuation_TrainingItemCourseEvaluationApprove : System.Web.UI.Page
{
    #region 页面参数
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            PlateResult1.ObjectType = ETMS.Components.Basic.Implement.BLL.BizEvaluationObjectType.ItemCourse;
            PlateResult1.ObjectID = TrainingItemCourseID.ToString();
            PlateResult1.IsApprove = true;
        }
    }
