<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EvaluationInfo.ascx.cs"
    Inherits="TraningImplement_ProjectCourseResource_ExOfflineHomework_Controls_EvaluationInfo" %>
        ...
        <div class="dv_information">
            <table class="GridviewGray fixedTable ">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblCourseIDEdit" runat="server" />
                    </td>
                </tr>
                <tr>
                    <th>
