...
public partial class TraningImplement_ProjectCourseResource_OnLineTestAdd : System.Web.UI.Page
{
    #region 页面参数
    /// <summary>
    /// 项目课程ID
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.aBack.HRef = this.ActionHref(string.Format("OnLineTest.aspx?TrainingItemCourseID={0}", TrainingItemCourseID));
    }
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            ETMS.WebApp.Manage.Extention.AlertMessageBox("请选择要添加的在线测试！");
            return;
        }
        else
        {
            try
            {
                ...
                ETMS.WebApp.Manage.Extention.SuccessMessageBox("提示", "在线测试添加成功！", "function (){window.location='"+this.ActionHref("OnLineTest.aspx?TrainingItemCourseID=" + TrainingItemCourseID.ToString())+"'}");
            }
