<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="OnLineHomeWork.aspx.cs" Inherits="TraningImplement_ProjectCourseResource_OnLineHomeWork" %>
                            ...
                            <asp:TemplateField HeaderText="操作" HeaderStyle-Width="80">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnEidt" runat="server" Text="编辑" CommandArgument='<%# Eval("ItemCourseResID") %>'></asp:LinkButton><a
                                        href='<%#  this.ActionHref(string.Format("~/QuestionDB/Testpaper/TestpaperView.aspx?ExerciseType=3&ExerciseID={0}", Eval("OnLineJobID")))%>' target="_blank">预览</a>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </cc1:CustomGridView>
