<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPagePop.Master" AutoEventWireup="true"
    CodeFile="CourseWareEdit.aspx.cs" Inherits="TraningImplement_ProjectCourseResource_CourseWareEdit" %>
    ...
    <div class="dv_information">
        <table class="GridviewGray">
            <tr>
                ...
                <td width="80%">
                    <asp:Label ID="lblCoursewareName" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <asp:Label ID="lblCoursewareTypeName" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <th>
