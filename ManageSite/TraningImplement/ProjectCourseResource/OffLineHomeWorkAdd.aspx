<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPagePop.Master" AutoEventWireup="true" CodeFile="OffLineHomeWorkAdd.aspx.cs" Inherits="TraningImplement_ProjectCourseResource_OffLineHomeWorkAdd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="dv_information">
        ...
        <div class="dv_submit">
            <input type="button" class="btn_Add" value="确定" onclick="javascript:popSuccessMsg('恭喜你保存成功！','提示',closeWindow);" />
