...
public partial class TraningImplement_ProjectCourseResource_ExcerciseStatus : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            InitialControlers();
            aBack.HRef = this.ActionHref(string.Format("OffLineHomeWork.aspx?CourseID={0}&TrainingItemCourseID={1}&TrainingItemID={2}", CourseID, TrainingItemCourseID, TrainingItemID));
        }
        Evaluated.ReLoad();
    }
