<%@ Page Title="培训项目信息调整" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master" AutoEventWireup="true" CodeFile="TraningProjectList.aspx.cs" Inherits="TraningImplement_TraningProjectAdjust_TraningProjectList" %>
            ...
            <cc1:CustomGridView ID="CustomGridView1" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="项目编码" ItemStyle-CssClass="alignleft" HeaderStyle-CssClass="alignleft " >
                        <ItemTemplate>
                            <cc1:ShortTextLabel ID="lblItemCode" runat="server" ShowTextNum="6" Text='<%# Eval("ItemCode")%>'></cc1:ShortTextLabel>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="课程数" HeaderStyle-Width="40" HeaderStyle-CssClass="alignright" ItemStyle-CssClass="alignright">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="允许报名" HeaderStyle-Width="60">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-Width="90">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="Lbtn_Edit" runat="server">编辑</asp:LinkButton><asp:LinkButton
                                ID="Lbtn_CourseList" runat="server">课程</asp:LinkButton><asp:LinkButton
