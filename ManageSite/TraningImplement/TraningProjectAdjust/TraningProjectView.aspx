<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master" AutoEventWireup="true" CodeFile="TraningProjectView.aspx.cs" Inherits="TraningImplement_TraningProjectAdjust_TraningProjectView" %>


<%@ Register Src="../TraningProjectManager/Controls/TraningProjectView.ascx" TagName="TraningProjectView"
    TagPrefix="uc1" %>
<%@ Register Src="../TraningProjectManager/Controls/TraningStudentListView.ascx" TagName="TraningStudentListView"
    TagPrefix="uc2" %>
