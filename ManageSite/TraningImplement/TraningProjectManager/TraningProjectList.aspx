<%@ Page Title="培训项目管理" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="TraningProjectList.aspx.cs" Inherits="TraningImplement_TraningProjectManager_TraningProjectList" %>
        ...
        <div class="dv_searchlist">
            ...
            <div class="dv_pagePanel" id="divPage1">
                <div class="dv_selectAll">
                    <input id="btnAdd" type="button" class="btn_Add" runat="server" value="新增" onclick="javascript:showWindow('新增培训项目','TraningProjectAdd.aspx',650,500)" />
                </div>
            ...
            <cc1:CustomGridView ID="CustomGridView1" runat="server" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-Width="145">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="Lbtn_Edit" runat="server" Enabled="false">编辑</asp:LinkButton><cc1:CustomLinkButton
                                    ...
                                    Text="删除" EnableConfirm="false" ConfirmTitle="提示" ConfirmMessage="确定删除吗？" Enabled="false" /><asp:LinkButton
                                        ID="lbtnCopy" runat="server">复制</asp:LinkButton><asp:LinkButton ID="lbtnView" runat="server">查看</asp:LinkButton></ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </cc1:CustomGridView>
            <!--列表 end-->
