<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CourseResourceView.ascx.cs"
    Inherits="TraningImplement_TraningProjectManager_Controls_CourseResourceView" %>
