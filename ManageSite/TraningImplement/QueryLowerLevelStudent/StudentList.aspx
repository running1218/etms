<%@ Page Title="查询下级培训学员" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="StudentList.aspx.cs" Inherits="TraningImplement_QueryLowerLevelStudent_StudentList" %>
        ...
        <div class="dv_searchbox">
            <table class="GridviewGray" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <cc1:DictionaryDropDownList runat="server" ID="DictionaryDropDownList1" DictionaryType="Dic_Organization"
                            IsShowAll="true" />
                    </td>
                    <th>
