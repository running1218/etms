<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master" AutoEventWireup="true" CodeFile="TraningProjectList.aspx.cs" Inherits="TraningImplement_UpProjectManager_TraningProjectList" %>
        ...
        <div class="dv_searchbox">
            <table class="GridviewGray" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>
                        <cc1:DictionaryDropDownList runat="server" ID="TraningDirectionType1" DictionaryType="Dic_TraningDirectionType"
                            IsShowAll="true" />
                    </td>
                </tr>
                <tr>
            ...
            <cc1:CustomGridView ID="CustomGridView1" runat="server" AutoGenerateColumns="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        ...
                        <ItemTemplate>
                            <a href="javascript:showWindow('设置对象','SetsObject.aspx')">设置对象</a>
                            <a href="javascript:showWindow('培训项目查看','TraningProjectView.aspx')">查看</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </cc1:CustomGridView>
