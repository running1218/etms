<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPagePop.Master" AutoEventWireup="true"
    CodeFile="CoursePeriodView.aspx.cs" Inherits="TraningImplement_ProjectCoursePeriod_CoursePeriodView" %>

<%@ Register Src="Controls/CoursePeriodView.ascx" TagName="CoursePeriodView" TagPrefix="uc1" %>
<%@ Register Src="Controls/SetsStudentListView.ascx" TagName="SetsStudentListView"
    TagPrefix="uc2" %>
