...
public partial class TraningImplement_ProjectCoursePeriod_CoursePeriodEdit : System.Web.UI.Page
{
    #region 页面参数
    /// <summary>
    /// 项目课程ID 
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            CoursePeriodInfo1.TrainingItemCourseID = TrainingItemCourseID;
            CoursePeriodInfo1.ItemCourseHoursID = ItemCourseHoursID;
        }
    }
}