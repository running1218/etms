<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MarkingEvaluated.ascx.cs" Inherits="Grade_GradeManage_Controls_MarkingEvaluated" %>
...
<div class="dv_searchlist ">
    ...
    <cc1:CustomGridView ID="GridViewList" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridViewList_RowDataBound">
        <Columns>
            <asp:BoundField DataField="LoginName" HeaderText="帐号" SortExpression="JobName" HeaderStyle-CssClass="alignleft" ItemStyle-CssClass="alignleft" HeaderStyle-Width="80">
            ...
            <asp:TemplateField HeaderText="上传时间" HeaderStyle-Width="80">
             ...
             <asp:TemplateField HeaderText="所属项目" ItemStyle-CssClass="alignleft" HeaderStyle-CssClass="alignleft">
              ...
              <asp:TemplateField HeaderText="实践名称" ItemStyle-CssClass="alignleft" HeaderStyle-CssClass="alignleft">
                <ItemStyle HorizontalAlign="Center" />
                <HeaderStyle HorizontalAlign="Center" />
                <ItemTemplate>
