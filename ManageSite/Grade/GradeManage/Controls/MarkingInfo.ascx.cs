...
public partial class Grade_GradeManage_Controls_MarkingInfo : System.Web.UI.UserControl, IMuliViewControl
{
    ...
    public void BindFromData_Edit(object domainModel)
    {
        if (!this.Page.IsPostBack)
        {
            ...
            //this.txtScoreEdit.Text = entity.Score.ToString();
    ...
    public void BindFromData_Browse(object domainModel)
    {
        ...
        this.lbScore.Text = entity.Score.ToString();
    ...
    public object UnBindFromData(object domainModel)
    {
        if (this.ControlMode == ViewMode.Edit)
        {
            ...
            entity.Evaluation = this.EvaluationDescription.Text;
            if (string.IsNullOrEmpty(this.txtScoreEdit.Text.Trim()))
            {
                entity.Score = null;
            }
            else
            {
                entity.Score= Convert.ToDecimal(this.txtScoreEdit.Text);
            }
