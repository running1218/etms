<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="GradeList.aspx.cs" Inherits="Grade_GradeManage_GradeList" %>
    ...
    <div>
        ...
        <div class="dv_searchbox">
            <table class="GridviewGray" border="0" cellpadding="0" cellspacing="0" id="tableQueryControlList"
                ...
                <tr>
                    ...
                    <td>
                        <cc1:DictionaryDropDownList runat="server" ID="ddl_Tr_ItemCourse999IsIssueGrade"
                            DictionaryType="Dic_TrueOrFalse" CssClass="select_60" />
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <td colspan="5">
                        <cc1:DateTimeTextBox ID="TxtItemBeginTime" runat="server" EndTimeControlID="TxtItemEndTime"></cc1:DateTimeTextBox>
                        至<cc1:DateTimeTextBox ID="TxtItemEndTime" runat="server" MaxLength="10" BeginTimeControlID="TxtItemBeginTime"></cc1:DateTimeTextBox>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="dv_searchlist">
            <asp:UpdatePanel ID="upList" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <cc1:CustomGridView ID="CustomGridView1" runat="server" CssClass="GridviewGray" EmptyDataSourceTip="没有任何记录！"
                        ...
                        IsRemeberChecks="true" DataKeyNames="TrainingItemID">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="测试数" HeaderStyle-CssClass="alignright" ItemStyle-CssClass="alignright"
                            ...
                            <asp:TemplateField HeaderText="学员数" HeaderStyle-CssClass="alignright" ItemStyle-CssClass="alignright"
            ...
            <cc1:CustomGridView ID="CustomGridView2" runat="server" CssClass="GridviewGray" EmptyDataSourceTip="没有任何记录！"
                AutoCreateColumnInsertIndex="0" AutoGenerateColumns="False" CurrentPageIndex="1"
                CustomAllowPaging="False" IsEmpty="False" IsRemeberChecks="true" DataKeyNames="TrainingItemID">
                <Columns>
                    <asp:TemplateField HeaderText="项目编码" ItemStyle-CssClass="alignleft" HeaderStyle-CssClass="alignleft field12">
                        <ItemStyle HorizontalAlign="Center" CssClass="alignleft" />
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                            <cc1:ShortTextLabel ID="lblItemCode" runat="server" ShowTextNum="10" Text='<%# Eval("ItemCode")%>'></cc1:ShortTextLabel>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="项目名称" ItemStyle-CssClass="alignleft" HeaderStyle-CssClass="alignleft">
                        <ItemStyle HorizontalAlign="Center" CssClass="alignleft" />
