<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Dictionary_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="dv_searchlist">
        ...
        <cc1:CustomGridView ID="GridViewList" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>             
                <asp:BoundField HeaderText="编码" DataField="ColumnCodeValue" ItemStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="alignleft field12" ItemStyle-CssClass="alignleft"/>
