<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View.aspx.cs" Inherits="Dic_Post_View"
...
<asp:Content runat="server" ID="PageContent" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="dv_submit">
        ...
        <cc1:CustomButton EnableConfirm="true" ConfirmTitle="删除提示" ConfirmMessage="确定要删除吗？"
            ...
            SkinID="DeleteOk" />
        <asp:Button ID="btnReturn" SkinID="Return" runat="server" Text="取消" OnClientClick="closeWindow()" /></div>
</asp:Content>
