<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="CourseCatalog_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="dv_searchlist">
        <!-- 数据呈现区域 -->
        <cc1:CustomGridView ID="GridViewList" runat="server" AutoGenerateColumns="False" PageSize="1000"
            DataKeyNames="ColumnCodeValue,ColumnNameValue,Code">
            <Columns>             
                <asp:BoundField HeaderText="编码" DataField="Code" ItemStyle-HorizontalAlign="Center"  HeaderStyle-CssClass="alignleft field12" ItemStyle-CssClass="alignleft"/>
                <asp:BoundField HeaderText="名称" DataField="ColumnNameValue" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="alignleft" ItemStyle-CssClass="alignleft" />              
                <asp:TemplateField ShowHeader="False" HeaderText="操作" HeaderStyle-Width="60">
                    <ItemTemplate>
