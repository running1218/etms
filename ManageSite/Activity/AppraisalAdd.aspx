<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AppraisalAdd.aspx.cs" Inherits="Activity_AppraisalAdd" EnableEventValidation="false" %>
...
<body style="overflow-y:auto;">
    ...
    <div>
        <uc2:Appraisal ID="appraisal" runat="server" Action="Add" />
    </div>
    </form>
