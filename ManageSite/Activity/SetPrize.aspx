<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MPageAdmin.Master"
    AutoEventWireup="true" CodeFile="SetPrize.aspx.cs" Inherits="Activity_SetPrize" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <div class="dv_searchlist">
            ...
            <!--列表 begin-->
            <cc1:CustomGridView ID="CustomGridView1" runat="server" AutoGenerateColumns="false" IsRemeberChecks="true" OnRowDataBound="CustomGridView1_RowDataBound"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="奖项" HeaderStyle-CssClass="field8" ItemStyle-CssClass="field8">
                        <ItemTemplate>
                            <asp:Label ID="lblPrizeName" runat="server" Text='<%# Eval("PrizeName") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderStyle-CssClass="field10" ItemStyle-CssClass="field10" HeaderText="操作">
                        <ItemTemplate>
                            <cc1:CustomLinkButton runat="server" ID="lbtnSetting" CommandArgument='<%# Eval("ProductID") %>' Text="设定"></cc1:CustomLinkButton>
                            <cc1:CustomLinkButton runat="server" ID="lbtnCancel" CommandArgument='<%# Eval("ProductID") %>'
                                CommandName="Cancel" Text="取消" EnableConfirm="true" ConfirmTitle="提示" ConfirmMessage="确定要取消奖项吗?" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </cc1:CustomGridView>
