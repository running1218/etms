...
public partial class Controls_UpFile : System.Web.UI.UserControl
{
    /// <summary>
    /// 上传请求的地址
    /// </summary>
    ...
    public int Width
    {
        get
        {
            return (ViewState["Width"] == null) ? 250 : (int)ViewState["Width"];
        }
        set
        {
    ...
    protected string GetFileTypes(string[] arr)
    {
