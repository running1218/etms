        ...
        if (context.Request.Files.Count > 0)
        {
            try
            {
                ...
                for (int j = 0; j < context.Request.Files.Count; j++)
                {
                    ...
                    {
                        filename = context.Request.Form["name"].Trim();
                    }
                ...
                delegate(string item)
                {
                    ...
                    if (total <= 1)
                    {
                        if (uploadFile.ContentLength > 0)
                        {
                            ...
                            filename = GetNewFileName(fileUploadConfig, filename);
                            ...
                            fileDefine.FileOldName = oldFileName;
                    ...
                    {
                        fullname = string.Format("{0}\\{1}.part", updir, pr + filename);
