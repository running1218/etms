...
{
    public class HomeworkDataAccess : AExamHomeWorkData
    {
        /// <summary>
        /// 查询试卷考试信息
        /// </summary>
        ...
        {
            string commandName = "Pr_KS_TestPaper_GetHomeworkPaper";
            #region Parameters
        ...
        /// <param name="dr"></param>
        /// <returns></returns>
        private Paper PopulateKS_TestPaperFromDataRow(DataRow dr)
        {
        ...
        {
            string commandName = "Pr_KS_UserHomework_StartNewTest";
            #region Parameters
            SqlParameter[] parms = SqlHelperParameterCache.GetCachedParameterSet(ConnectionString.ETMSRead, commandName);
            if (parms == null)
            {
        ...
        {
            string commandName = "pr_KS_UserHomework_SubmitTestPaper";
            #region Parameters
            SqlParameter[] parms = SqlHelperParameterCache.GetCachedParameterSet(ConnectionString.ETMSRead, commandName);
            if (parms == null)
            {
        ...
        {
            string commandName = "Pr_KS_UserHomework_GetUserTestPaper";
            #region Parameters
            SqlParameter[] parms = SqlHelperParameterCache.GetCachedParameterSet(ConnectionString.ETMSRead, commandName);
            if (parms == null)
            {
