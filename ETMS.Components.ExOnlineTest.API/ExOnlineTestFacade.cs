...
namespace ETMS.Components.Courseware.Implement
{
    ...
    using ETMS.Components.ExOnlineTest.API;
    using ETMS.Components.Basic.Implement.DAL.Common;

    public class ExOnlineTestFacade : DefaultComponent, ICourseResourcesFacade
    {
        ...
        private static string sqlModal = @"select 
                ...
                Ex_OnLineTest.*
            from Res_CourseRes
                inner join Ex_OnLineTest on Ex_OnLineTest.OnLineTestID=Res_CourseRes.ResID
                where 1=1 and Res_CourseRes.CourseResTypeID='5'
        ...
        public Int32 GetResourcesTotal(Guid courseID)
        {
            ...
            string key = string.Format("CourseExOnlineTest_{0}", courseID);
        ...
        {
            return Basic.API.Entity.EnumResourcesType.OnLineTest;
        }
