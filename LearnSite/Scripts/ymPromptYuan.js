...
(function () {
    ...
    (function () {
        ...
        /*窗体*/
        "<div id='ym-window' style='position:absolute;z-index:10001;display:none'>", IE6 ? "<iframe scrolling='yes' style='overflow:auto;overflow-x:hidden;width:100%;height:100%;position:absolute;top:0;left:0;z-index:-1'></iframe>" : '', "<div class='ym-tl' id='ym-tl'><div class='ym-tr'><div class='ym-tc' style='cursor:move;'><div class='ym-header-text'></div><div class='ym-header-tools'></div><div class='ym-redArrow'></div></div></div></div>", "<div class='ym-ml' id='ym-ml'><div class='ym-mr'><div class='ym-mc'><div class='ym-body'></div></div></div></div>", "<div class='ym-ml' id='ym-btnl'><div class='ym-mr'><div class='ym-btn'></div></div></div>", "<div class='ym-bl' id='ym-bl'><div class='ym-br'><div class='ym-bc'></div></div></div>", "</div>"].join('');
        ...
        var getPos = function (f) {
            ...
            var pos = [rootEl.clientWidth - ym_win.offsetWidth, (rootEl.clientHeight - ym_win.offsetHeight) / 2 + parent.document.documentElement.scrollTop, flag ? 0 : rootEl.scrollLeft, flag ? 0 : rootEl.scrollTop];          
...
//                top: 0,
        ...
        var winVisible = function (visible) {
            ...
            ym_body.innerHTML = !curCfg.iframe ? ('<div class="ym-content">' + curCfg.message + '</div>') : "<iframe scrolling='no'id='iframe1' width='100%' style='overflow:hidden;' height='100%' border='0' frameborder='0' src='" + curCfg.message + "'></iframe>"; //内容
