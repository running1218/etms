<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/Popup.master" CodeBehind="UpOffLineJob.aspx.cs" Inherits="ETMS.Studying.Study.UpOffLineJob" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="upload_box">
      ...
      <%--  <asp:HiddenField runat="server" ID="HdFilePath" />
        ...
        <p class="prompt_info">.doc.docx.xls.xlsx.ppt.pptx.zip.rar<br />大小不要超过100MB</p>
