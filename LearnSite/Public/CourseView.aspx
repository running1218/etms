<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Default.master" AutoEventWireup="true" CodeBehind="CourseView.aspx.cs" Inherits="ETMS.Studying.Public.CourseView" %>
                            ...
                            <asp:Repeater ID="CourseResourceList" runat="server">
                                <ItemTemplate>
                                    <li isopen="<%# Eval("IsOpen") %>">
                                        ...
                                        <p>
                                            <span class="ellipsis"><%# Eval("Name") %> </span>
                                            <span><%# Eval("TeacherName") %></span>
                                            <span><%# Eval("ContentTime") %> </span>                                        
                                            <span class="content-action"><a href="<%# getStudyUrl(Eval("IsOpen").ToBoolean(),Eval("ContentID").ToGuid(),CourseName,Eval("Name").ToString(),Eval("Type").ToString(),CourseID) %>">试学</a></span>
                                        </p>
                                    </li>
                                </ItemTemplate>
                            </asp:Repeater>
