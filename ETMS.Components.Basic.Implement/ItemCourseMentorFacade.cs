...
namespace ETMS.Components.Basic.Implement
{
    ...
    /// 黄中福：2012-05-20
    /// </summary>
    public class ItemCourseMentorFacade : DefaultComponent, ITrainingItemCourseResourcesFacade
    {
        ...
        {
            return logic.GetMentorDataTotalByTrainingItemCourseID(trainingItemCourseID);
        }
