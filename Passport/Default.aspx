...
<head id="Head1" runat="server">
    ...
    <link href="App_Themes/ThemeDefault/login.css" rel="stylesheet" type="text/css" />
...
<body class="login-body">
    ...
    <script src="<%=ETMS.Utility.WebUtility.AppPath %>/JScript/login.js" type="text/javascript"></script>
    ...
    <form id="form1" runat="server">
        ...
        <script id="notice" type="text/x-jquery-tmpl">
            {{each DataList }} 
            <li>
                <p class="notice-detail-title" id="${ArticleID}">
                    <a href="Notice.aspx?BulletinID=${ArticleID}" target="_blank">${MainHead}</a></p>
                <p class="notice-detail-time">${BeginDate}</p>
            </li> 
            {{/each}}
        </script>
    </form>
