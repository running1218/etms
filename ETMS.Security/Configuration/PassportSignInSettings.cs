    ...
    public sealed class PassportSignInSettings : ConfigurationSection
    {
        ...
        public static PassportSignInSettings GetConfig()
        {
            PassportSignInSettings result =
                (PassportSignInSettings)ConfigurationManager.GetSection("etms.security/passportSignInSettings");

            ConfigurationExceptionHelper.CheckSectionNotNull(result, "etms.security/passportSignInSettings");
